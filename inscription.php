...
<?php include('./services/entete.php');?>
    ...
    <div class="main-block">
      ...
      <form action="./services/inscriptionService.php" method="POST">
        ...
        <label id="icon" for="mpConf"><i class="fas fa-unlock-alt"></i></label>
        <input type="password" name="mpConf" id="mpConf" placeholder="confirmation mot de passe" required/>
        <hr>
    
        <div class="btn-block">
          <button class="buttonForm" type="submit" >S'inscrire</button>
        </div>
      </form>
